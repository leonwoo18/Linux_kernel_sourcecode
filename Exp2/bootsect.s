...
! Get disk drive parameters, specifically nr of sectors/track
	...
	seg cs
	mov	sectors,cx
	mov	ax,#INITSEG  !linux-0.11对es赋值0x9000，因为boot被搬运到了9000位置
	mov	es,ax
...
!-----如果不搬运boot到0x9000的话，要对es赋值0x07c0
!-----mov     ax,#0x07c0             
!-----mov     es,ax                   
...
!－－－－－－－－－－－－－核心代码－－－－－－－－－－－－－－－－－
	jmpi	0,SETUPSEG       !跳转到0x9020（setup.s程序的开始处）
